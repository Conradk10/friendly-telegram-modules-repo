...
class JacquesMod(loader.Module):
	...
	strings = {
		'name': 'Жаконизатор',
		'usage': '/jac <текст/реплай на сообщение с текстом',
	}
	def __init__(self):
	...
	async def jaccmd(self, message):
		""".jac <реплай на сообщение/свой текст>"""
		...
		pic = requests.get("https://raw.githubusercontent.com/semolik/mymodules/master/stuff/Jac.jpg")
